...
class Chatbot:
    ...
    async def set_starters(self):
        ...
        return [
            cl.Starter(
                label="Top Student Questions?",
                message="What were the top questions aksed in the last week?",
            ),
            cl.Starter(
                label="Any issues with the final project?",
                message="Are there any common issues with the final project?",
            ),
        ]
...
async def start_chainlit_instructor_app(user=None):
...
if __name__ == "__main__":
    ...
    asyncio.run(start_chainlit_instructor_app())
